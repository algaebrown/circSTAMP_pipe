...
workdir: '/tscc/projects/ps-yeolab5/hsher/Tao_circ_BRCA_de_jack'
...
indir1 = '/tscc/projects/ps-yeolab5/hsher/circ_nextera_iter14/output' ### CHANGE HERE TO CONTAIN THE CIRI GTF FILES
for f in Path(indir1).glob('*.gtf'):
    name = f.name.replace('.gtf', ''
